...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "OneHashCal";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@onehash.ai";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "OneHashCal, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "OneHashCal";
...
export const LOGO = "/onehash-full-logo.svg";
export const LOGO_ICON = "/onehash-logo.svg";
