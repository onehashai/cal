...
4. Test your authentication —> First you have to install Zapier in the OneHash App Store and generate an API key, use this API key to test your authentication (only zapier Api key works)
