...
const themeConfig = {
  ...
  titleSuffix: " | OneHashCal",
  logo: <h4 className="m-0">OneHashCal</h4>,
  head: (
    <>
      ...
      <meta name="og:title" content="OneHashCal Documentation" />
      <meta name="og:image" content={SEO_IMG_DEFAULT} />
      <meta name="apple-mobile-web-app-title" content="OneHashCal Docs" />
  ...
  footerText: <>© {new Date().getFullYear()} OneHashCal, Inc. All rights reserved.</>,
};
