...
const themeConfig = {
  ...
  titleSuffix: " | OneHash",
  logo: <h4 className="m-0">OneHash</h4>,
  head: (
    <>
      ...
      <meta name="og:title" content="OneHash Documentation" />
      <meta name="og:image" content={SEO_IMG_DEFAULT} />
      <meta name="apple-mobile-web-app-title" content="OneHash Docs" />
  ...
  footerText: <>© {new Date().getFullYear()} OneHash, Inc. All rights reserved.</>,
};
